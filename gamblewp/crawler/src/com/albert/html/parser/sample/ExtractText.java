...
public class ExtractText {
	public static void main(String[] args) throws Exception {
		String sourceUrlString="https://bet.i-win.com.tw/SBP2Web/betting.do?method=getBettingList&sportCode=FB&poolCode=ALL";
		//String sourceUrlString="http://www42.pinnaclesports.com/Members/gameselection.asp?sportType=Soccer&sportSubType=Intl+Friendl&descr=7";
		if (args.length==0)
