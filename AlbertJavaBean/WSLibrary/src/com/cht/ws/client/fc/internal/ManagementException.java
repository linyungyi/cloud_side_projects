...
public class ManagementException  extends org.apache.axis.AxisFault  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:AuthoringWebInterfaces:authoring:axis:management:server:flashcast:macromedia:com", "ManagementException"));
