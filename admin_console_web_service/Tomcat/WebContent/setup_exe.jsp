...
<%
 String V_MSISDN = request.getParameter("V_MSISDN");
 ...
 String res="",fast_XML="";
        ...
        fast_XML="<RING_ALLDAY><UI>WEB</UI><MSISDN>"+ID+"</MSISDN><V0>"+V_MSISDN+"</V0></RING_ALLDAY>";
	      if(fast_XML.indexOf("null")>0)
	       {
	           response.sendRedirect("main.jsp");
		   return;
	       }
...
//----------------解析res-------------------------------------------------
  if(res.indexOf("Success")>0)
    {
             response.sendRedirect("setup_result.jsp?result=Success&Type=setup");

    }
    else
    {
             response.sendRedirect("setup_result.jsp?result=fail&Type=setup");   
    }
%>
